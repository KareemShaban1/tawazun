                     ...
                     <li>
                      ...
                      <li>
                        ...
                        <ul id="users-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="">{{ trans('sidebar_trans.Add_User') }}  </a> </li>
                            <li> <a href="">{{ trans('sidebar_trans.All_Users') }}</a> </li>
                            <li> <a href="">{{ trans('sidebar_trans.Trash_Users') }}</a> </li>
                    ...
                    <li>
                      ...
                      <li>
                        ...
                        <ul id="reports-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{Route('backend.reports.create')}}">{{ trans('sidebar_trans.Add_Report') }}  </a> </li>
                            <li> <a href="">{{ trans('sidebar_trans.All_Reports') }}</a> </li>
                            <li> <a href="">{{ trans('sidebar_trans.Trash_Reports') }}</a> </li>
