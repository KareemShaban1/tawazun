            ...
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label> {{trans('doctor_trans.Job_ID')}}  <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-outline mb-4">
                                ...
                                <select class="custom-select mr-sm-2" name="job_description">
                                    ...
                                    <option  value="HCP Doctor">{{trans('doctor_trans.HCP_Doctor')}}</option>
                                    <option  value="HCP Nurse">{{trans('doctor_trans.HCP_Nurse')}}</option>
