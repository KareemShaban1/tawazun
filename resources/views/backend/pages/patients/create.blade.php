...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">  {{trans('patient_trans.Add_Patient')}}</h4>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label> {{trans('patient_trans.N_Number')}}  <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="blood_group"> {{trans('patient_trans.Blood_Group')}} <span class="text-danger">*</span></label>
